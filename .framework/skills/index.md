...
| Skill | Phases | Role |
|-------|--------|------|
| [[.framework/skills/fluentit-bdd-features\|BDD Feature Generator]] | 8 | Pipeline entry — specs → features |
| [[.framework/skills/fluentit-bdd-frontend-steps\|BDD Frontend Steps]] | 11 | Frontend glue — steps + mocks + contracts |
| [[.framework/skills/fluentit-bdd-backend-steps\|BDD Backend Steps]] | 7 | Backend glue — API E2E steps |
| [[.framework/skills/fluentit-tdd-frontend\|TDD Frontend]] | 8 | Frontend implementation |
| [[.framework/skills/fluentit-tdd-backend\|TDD Backend]] | 7 | Backend implementation |

### Scaffolding Skills

| Skill | Role |
|-------|------|
| [[.framework/skills/fluentit-domain-entity\|Domain Entity]] | Interview-driven DDD entity creation |
| [[.framework/skills/fluentit-api-contracts\|API Contracts]] | DTOs + response types + frontend wiring |
| [[.framework/skills/fluentit-backend-module\|Backend Module]] | Full backend module (CQRS/MVC/Hexagonal) |

### Workflow Skills

| Skill | Role |
|-------|------|
| [[.framework/skills/fluentit-frontend-guide\|Frontend Guide]] | Feature dev from specs to production |
| [[.framework/skills/fluentit-pr\|Pull Request]] | Commit → version → PR → ticket update |
| [[.framework/skills/fluentit-review\|Code Review]] | Clean AI-generated code |

### Meta Skills

| Skill | Role |
|-------|------|
| [[.framework/skills/fluentit-orchestrator\|Project Orchestrator]] | Detects state, routes to correct skill, manages pipeline |
